...
Реализовать модель системы массового обслуживания типа
M |M |1|∞  в xcos

# Задание

1. Создать суперблок, моделирующий поступление заявок
2. Создать суперблок, моделирующий процесс обработки заявок
3. Создать полную модель с помощью полученных суперблоков
...
![Суперблок, моделирующий поступление заявок](image/2.jpg){#fig:002 width=70%}
...
![Суперблок, моделирующий обработку заявок](image/3.jpg){#fig:003 width=70%}
...
![Поступление и обработка заявок](image/6.jpg){#fig:006 width=70%}
